...
5. **分类汇总报警**: 按自定义分类（AI硬件、芯片等）分组展示，定时推送所有股票涨跌幅
6. **双通道报警**: 控制台格式化输出 + 飞书机器人推送
7. **冷却机制**: 同只股票 300 秒内不重复报警
...
| `console_alert.summary_interval_seconds` | `60` | 分类汇总推送间隔（秒） |
...
```
==============================================================
  2026/05/22 09:25:00 异动报警
  涨停 2只 | 跌停 0只 | 上涨（>=1%）23只 | 下跌（>=1%）7只
==============================================================
  AI硬件: 澜起科技 +1.30%，中兴通讯 +1.25%，中芯国际 +0.80%
  AI应用: 科大讯飞 +2.10%，商汤科技 +0.55%
  商业航天: 航天电子 +0.90%
  芯片: 澜起科技 +1.30%，芯片ETF东财 +2.22%
  新能源: 亿纬锂能 -1.08%
  医药: 药明康德 -0.57%
  消费: 格力电器 -0.57%
==============================================================
